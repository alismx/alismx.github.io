...
- [chore(security): add descriptions, checkov skips, and CI permissions](https://github.com/CDCgov/dibbs-aws/pull/94) on [CDCgov/dibbs-aws](https://github.com/CDCgov/dibbs-aws)
